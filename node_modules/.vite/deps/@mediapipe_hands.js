    ...
    (function() {
      ...
      function Wa(a) {
        ...
        if (16 > a.length)
          ...
          a = BigInt(a), G = Number(a & BigInt(4294967295)) >>> 0, H = Number(a >> BigInt(32) & BigInt(4294967295));
        else {
          var b = +("-" === a[0]);
          H = G = 0;
      ...
      function bc(a, b, c) {
        if (c) {
          ...
          for (e in c) {
            var g = c[e], f = g.qa;
            f || (d.J = g.wa || g.oa.W, g.ia ? (d.aa = cc(g.ia), f = function(h) {
            ...
            case 2:
              ...
              if ("object" === typeof window)
                return cd("createMediapipeSolutionsWasm", { locateFile: a.locateFile }), cd("createMediapipeSolutionsPackedAssets", { locateFile: a.locateFile }), f = b.filter(function(n) {
                  ...
                  return E(function(w) {
                    if (1 == w.h)
                      return n = window.createMediapipeSolutionsWasm, q = window.createMediapipeSolutionsPackedAssets, t = a, D(w, n(q), 2);
                    t.i = w.i;
                    w.h = 0;
                  });
                }), m = function() {
                        ...
                        for (w = 0; w < n.length; ++w) {
                          ...
                          if (t.ba)
                            for (v = 0; v < t.ba.length; ++v)
                              B = q.data, J = B.addClassification, I = w, u = t.ba[v], C = new Z(), V(C, 2, u.score), u.index && U(C, 1, u.index), u.label && U(C, 3, u.label), u.displayName && U(C, 4, u.displayName), u = C.l(), J.call(B, I, u);
                        }
                        q = q.data;
                        break a;
                      default:
      ...
      function od(a) {
        ...
        this.h = new fd({ locateFile: a.locateFile, files: function(c) {
          ...
          onChange: function(c) {
            ...
            return E(function(f) {
              if (1 == f.h)
                return d = nd(c), e = "third_party/mediapipe/modules/hand_landmark/" + d, D(f, hd(b.h, d), 2);
              g = f.i;
